...
public sealed class CreateCountryUseCase
{
    ...
    public async Task<CountryAggregate> ExecuteAsync(string name, CancellationToken cancellationToken = default)
    {
        // CountryId(1) es un placeholder; EF Core reemplaza el Id al insertar (ValueGeneratedOnAdd)
