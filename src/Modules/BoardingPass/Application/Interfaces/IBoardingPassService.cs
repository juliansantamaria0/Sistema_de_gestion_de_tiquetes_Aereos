...
public interface IBoardingPassService
{
    ...
    Task<BoardingPassDto?>             GetByCodeAsync(string boardingPassCode,                                                                           CancellationToken cancellationToken = default);
    Task<BoardingPassDto>              CreateAsync(string boardingPassCode, int checkInId, int? gateId, string? boardingGroup, int flightSeatId,         CancellationToken cancellationToken = default);
