...
public interface IReservationService
{
    ...
    Task<ReservationDto>              CreateAsync(int customerId, int scheduledFlightId, int reservationStatusId, CancellationToken cancellationToken = default);
    Task<ReservationDto>              CreateForCurrentUserAsync(int scheduledFlightId, int reservationStatusId, CancellationToken cancellationToken = default);
