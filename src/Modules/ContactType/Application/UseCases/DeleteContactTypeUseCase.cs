...
public sealed class DeleteContactTypeUseCase
{
    private readonly IContactTypeRepository _repository;
    private readonly IUnitOfWork            _unitOfWork;

    public DeleteContactTypeUseCase(IContactTypeRepository repository, IUnitOfWork unitOfWork)
    {
    ...
    {
        await _repository.DeleteAsync(new ContactTypeId(id), cancellationToken);
